...
public class PersonalInfo implements Serializable{
    ...
    public PersonalInfo(Long id, String uid, String header, String name,
            @NotNull String cardId, String address, int gender, String nation,
            String birthday, String signDepartment, @NotNull String validStartDate,
            @NotNull String validEndDate) {
        this.id = id;
        this.uid = uid;
        this.header = header;
        this.name = name;
    ...
    public List<HistroyInfo> getHistoryList() {
        if (historyList == null) {
            ...
            List<HistroyInfo> historyListNew = targetDao
                    ._queryPersonalInfo_HistoryList(id);
            synchronized (this) {
                if (historyList == null) {
